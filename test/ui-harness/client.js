		...
		*/
		function AddProviderPanel(props) {
			...
			*/
			...
			return react.default.createElement("div", { className: "pv_pc" }, react.default.createElement("div", {
			...
			}, t("prov.cancel"))), test.message === "" ? null : react.default.createElement("div", { className: "plan_note" + (test.phase === "fail" ? " plan_badText" : "") }, test.message), test.phase === "ok" && test.models.length > 0 ? react.default.createElement("div", { className: "pv_modelPick" }, test.models.map(function(m, i) {
				return react.default.createElement("label", {
					key: m.id,
					className: "pv_modelPickItem"
				}, react.default.createElement("input", {
					type: "checkbox",
				...
				}), react.default.createElement("span", null, m.name !== void 0 && m.name !== "" ? m.name + "（" + m.id + "）" : m.id));
