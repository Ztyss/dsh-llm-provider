	...
	factory: (require) => {
		...
		*/
		function modelEditRow(row, _patch, remove, onToggle, busy, expanded, onToggleExpand) {
			...
			return react.default.createElement("div", {
				...
				className: "pv_mIdPen",
				title: editable ? "点击编辑这条模型的显示名 / 上下文 / 最大输出 / 能力" : void 0,
				onClick: editable ? function() {
					onToggleExpand(row.id);
				} : void 0
			}, editable ? "✎" : null), react.default.createElement("span", {
				...
				for (var i = 0; i < list.length; i += 1) {
					...
					if (row.declared !== void 0) {
						...
						if (row.edited === true) {
							...
							if (row.reasoning !== void 0) declared.reasoning = row.reasoning === true;
						}
						out.push(declared);
						continue;
					}
			...
			*/
			...
			function rowEditPanel(row) {
				...
				return react.default.createElement("div", {
					...
					key: "panel-" + row.id
				}, react.default.createElement("div", { className: "pv_meFormTitle" }, "编辑模型参数（只改草稿，点「保存」落盘）"), panelField("显示名", row.name !== row.id ? row.name : "", function(next) {
					...
					className: "pv_line pv_row",
					key: "p-caps"
				}, react.default.createElement("span", null, "能力"), react.default.createElement("span", { className: "pv_mePanelCaps" }, capToggle("视觉", "vision", row.vision === true, "支持图片输入（写进模型的 input 模态）", "pv_capVision"), capToggle("视频", "video", row.video === true, "支持视频输入（写进模型的 input 模态）", "pv_capVideo"), capToggle("推理", "reasoning", row.reasoning === true, "支持思维链（声明条目写 reasoning: true）", "pv_capReason"))), react.default.createElement("div", {
					className: "pv_meActs",
					key: "p-acts"
				}, react.default.createElement("button", {
					type: "button",
		...
		*/
		function ProviderSettingsSection() {
			...
			var usageWaitState = react.default.useState(true);
			var usageWait = usageWaitState[0];
