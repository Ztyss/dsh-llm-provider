...
function loadBridge() {
	try {
		...
		if (!existsSync(bridgeLib) || recordedHash !== sourceHash) {
...
//#endregion
export { activePiAiRoot, bridgeRequirements, bundleSpecifiers, compareVersions, copyTreeNoLinks, ensureSafeCopy, installedVersions, isDirectoryLink, loadBridge, mergeStatus, obsoleteSafeVersions, piAiCandidates, piAiEntryMissing, piAiNeedsRestart, piAiRequirements, probePiAi, readPiAiPreference, readVendorStatus, removeDirectoryLink, removeLinkOrDir, removeTree, repairPiAiFromCopy, safeCandidates, safeInstalledVersions, safePiAiDir, safeRootDir, setPiAiPreference, syncBridgeLinks, updateStatus, vendorDir };
