...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function defaultEffortOf(model) {
      ...
      return typeof model.reasoning.default === 'string' ? model.reasoning.default : undefined
    }
    ...
    function loadModelCatalog() {
      return fetch('/api/session/modelCatalog', {
        ...
        .then(function (envelope) {
          ...
          return { groups: normalizeGroups(value.groups), default: normalizeSelection(value.default) }
        })
    }
    ...
    function normalizeSelection(value) {
      ...
      return typeof value.reasoningEffort === 'string'
