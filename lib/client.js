		...
		function ProviderSettingsSection() {
			...
			*/
			...
			for (var i = 0; i < accounts.length; i += 1) (function(account) {
				...
				}, caretSvg(expanded))), expanded ? null : alerts.map(function(alertRow) {
					if (alertRow.key === "err") return null;
					return react.default.createElement("div", {
						className: "pv_pcAlert plan_badText",
						key: alertRow.key,
						title: alertRow.text
					}, alertRow.text);
				}), expanded ? react.default.createElement("div", { className: "pv_pcBody" }, bodyRows) : null));
			})(accounts[i]);
