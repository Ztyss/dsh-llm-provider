...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function withoutAccount(payload, id) {
      if (payload === null || payload === undefined || !Array.isArray(payload.accounts)) return payload
      return {
        ...payload,
        accounts: payload.accounts.filter(function (account) {
    ...
    function withRefreshedAccount(payload, fresh) {
      if (payload === null || payload === undefined || !Array.isArray(payload.accounts)) return payload
      return {
        ...payload,
        accounts: payload.accounts.map(function (account) {
