    ...
    function ModelSwitchSeat(props) {
      ...
      if (selection !== undefined && selection !== null) {
        for (var gi = 0; gi < groups.length; gi += 1) {
          ...
          for (var mi = 0; mi < groups[gi].models.length; mi += 1) {
            if (groups[gi].models[mi].id === selection.model) {
              currentGroup = groups[gi]
              currentModel = groups[gi].models[mi]
            }
          }
        }
      }
      ...
      var modelLabel = waiting
        ...
        : (currentModel !== undefined
            ? String(currentGroup !== undefined && currentGroup.name ? currentGroup.name : selection.provider)
              + '/' + String(currentModel.name ? currentModel.name : currentModel.id)
            : (selection === undefined || selection === null ? '选择模型' : String(selection.provider) + '/' + String(selection.model)))
          ...
          ;(function (g) {
              ...
              ;(function (model) {
                ...
                sectionRows.push(
                  react.createElement(
                    ...
                    react.createElement('span', { className: 'ms_name' }, model.name),
            ...
            groupSections.push(
              react.createElement(
                ...
                react.createElement('div', { className: 'ms_groupTitle' }, g.name),
                sectionRows,
              ),
            )
          })(groups[gs])
      ...
      return react.createElement(
        ...
        react.createElement('div', { className: 'pv_pcBody', style: { borderTop: '0', paddingTop: '10px', gap: '6px' } },
          ...
          react.createElement(
            ...
            react.createElement('span', { className: 'plan_tag pv_push' }, '密钥存为 ' + form.apiKeyEnv),
          ),
          react.createElement(
            'div',
            { className: 'pv_actRow' },
            ...
            if (account.apiKeyEnv !== undefined) {
              bodyRows.push(
                react.createElement(
                  ...
                  react.createElement('span', null, '密钥存为'),
                  react.createElement('span', { className: 'pv_field' }, String(account.apiKeyEnv)),
                ),
              )
            }
