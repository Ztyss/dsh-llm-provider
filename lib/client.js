							...
							onSaved: function(message, models) {
								...
								setDetailsById(function(prev) {
									...
									for (var i = 0; i < models.length; i += 1) {
										...
										if (entry.input !== void 0) merged.input = entry.input;
