			...
			function payloadFrom(list) {
				...
				for (var i = 0; i < list.length; i += 1) {
						...
						if (row.edited === true) {
							...
							if (row.reasoning !== void 0) {
								...
								if (row.reasoning === true) {
									...
									if (effortDraft === void 0 && row.inPiAi !== true) effortDraft = prefillEffortsOf(row.declared, props.details, account.id, row.id);
					...
					if (row.reasoning === true) {
						...
						var customEffort = effortsToDeclared(row.effortsDraft !== void 0 ? row.effortsDraft : prefillEffortsOf(void 0, props.details, account.id, row.id), void 0);
