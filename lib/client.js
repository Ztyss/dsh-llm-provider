		...
		*/
		...
		var LOCAL_DICT = {
			zh: {
				...
				"prov.pingOk": "连通正常 · {id} · {latency}ms",
				"prov.added": "已添加 {id}",
			...
			en: {
				...
				"prov.pingOk": "Reachable · {id} · {latency}ms",
				"prov.added": "Added {id}",
