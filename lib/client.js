		...
		*/
		function ModelListEditor(props) {
			...
			*/
			...
			return react.default.createElement("div", { className: "pv_me" }, react.default.createElement("div", { className: "pv_hint" }, declaredCount > 0 ? "当前只服务清单里的 " + String(declaredCount) + " 个模型。" : "当前跟随 pi-ai 目录（" + String(rows.length) + " 个可用）。"), react.default.createElement("div", { className: "pv_meList" }, [colHead].concat(rows_)), react.default.createElement("div", { className: "pv_meAdd" }, react.default.createElement("input", {
				className: "pv_field",
				type: "text",
