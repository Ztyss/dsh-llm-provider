		...
		*/
		function AddProviderPanel(props) {
			...
			*/
			...
			}, t("prov.keyLink"))), react.default.createElement("div", { className: "pv_line pv_row" }, react.default.createElement("span", null, t("prov.apiBase")), fieldEditable === true && form.baseURL === "" ? react.default.createElement("input", {
				className: "pv_field pv_key",
				value: form.baseURL,
				onChange: function(event) {
